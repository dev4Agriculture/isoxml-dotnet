...
public static class Program
{
    ...
    public static void ReadManufacturer()
    {
        ...
        var wsmBytes = device.ClientNAME;
        var wsm = new WSM(wsmBytes);
        Console.WriteLine("Manufacturer of The TaskSet: See https://www.isobus.net/isobus/manufacturerCode/" + wsm.ManufacturerCode);
    }
