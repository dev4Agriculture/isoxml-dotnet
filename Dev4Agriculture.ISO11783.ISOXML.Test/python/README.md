...
```
Dev4Agriculture.ISO11783.ISOXML.Test/python/
...
- For Docker option: Docker installed and running

### Security Options

This project provides multiple security levels for running Python code:

#### 🔒 **Safe Mode (Recommended)**
Uses Python's restricted execution with blocked dangerous operations:
...
```bash
python safe_runner.py test_cases.py
```

#### 🐳 **Docker Container (Maximum Security)**
Runs code in completely isolated container:
...
```bash
python docker_runner.py test_cases.py
```

#### 🚀 **Easy Execution**
Use the provided scripts:
- **Windows**: `run_safe.bat`
- **PowerShell**: `run_safe.ps1`
